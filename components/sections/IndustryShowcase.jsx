...
const INDUSTRIES = [
  ...
  },
  {
    ...
    stat: { value: 40, suffix: '%', label: 'fewer front-desk interruptions' },
    useCases: [
      { title: 'Reservations', detail: 'Take and modify bookings by phone or text.' },
      { title: 'Guest concierge', detail: 'Answer amenity and check-in questions instantly.' },
      { title: 'Post-stay outreach', detail: 'Automated review requests and rebooking offers.' },
    ],
    products: ['Receptionist', 'Messenger', 'Outreach'],
    quote: {
  ...
  },
  {
    ...
    name: 'E-commerce',
    icon: ShoppingCart,
    tagline: 'Recover carts. Ship status updates. Handle returns without staff.',
    stat: { value: 25, suffix: '%', label: 'cart recovery rate' },
    useCases: [
      { title: 'Cart recovery', detail: 'Well-timed text follow-ups for abandoned carts.' },
      { title: 'Order updates', detail: 'Proactive shipping and tracking notifications.' },
      { title: 'Returns handling', detail: 'Automate refunds, exchanges, and tracking inquiries.' },
    ],
