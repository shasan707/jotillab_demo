...
const CONTACT_QUESTIONS = [
  { id: 'business_name', label: 'Business name', type: 'text', required: true, placeholder: 'Acme Salon', prompt: 'First things first, what is your business called?' },
...
export function getIntakeConversation(slug) {
  ...
  return [
    { title: 'About you', intro: null, questions: CONTACT_QUESTIONS },
